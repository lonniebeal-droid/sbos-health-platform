...
import { ShieldAlert, FileText, Search, Building2, DollarSign } from 'lucide-react';

export const InsuranceHub: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'claims' | 'prior_auth' | 'eligibility' | 'pricing'>('claims');
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'pricing' && <PricingComparison />}
